...
----------------------------|-----------|---------------------------------------------|
 ...
 [cluster-capacity](assets/cluster-capacity-metrics.ipynb) | query | SQL query to report cluster resource usage and capacity. |
 [cluster-listing](assets/cluster-listing.ipynb) | query | SQL query to list all clusters and their key properties. |
